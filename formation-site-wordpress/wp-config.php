...
define( 'DB_NAME', 'formation-site-db' );

/** Database username */
define( 'DB_USER', 'tayk0oo' );

/** Database password */
define( 'DB_PASSWORD', 'UfLv45G^EBy^gn5hoq#zY2' );
...
define('FTP_USER', 'tayk0oo');
define('FTP_PASS', 'UfLv45G^EBy^gn5hoq#zY2');
